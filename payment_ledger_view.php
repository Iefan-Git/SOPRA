    ...
    <form method="get" action="payment_ledger.php" id="filterForm">
      ...
      <div class="panel-row" style="margin-top:16px;">
        ...
        <div style="margin-left:auto;display:flex;gap:10px;flex-wrap:wrap;">
          <a class="btn export-btn" href="payment_ledger.php?<?= buildQuery(['export_month' => 1]) ?>" title="Export payment status for a single month">Export This Month</a>
          <a class="btn export-btn" href="payment_ledger.php?<?= buildQuery(['export' => 1]) ?>" title="Export the full 12 months">Export Full Year</a>
...
<div class="modal">
    <h3>Manage Users</h3>
    <div class="viewer-note" style="margin-bottom:14px;">There is no self-registration. All accounts (admin &amp; user) can only be created here by an Admin.</div>
    ...
    <div>
      <?php foreach ($allUsers as $u): ?>
        <div class="user-row">
          <span>
            <?= e($u['username']) ?>
            <?php if ($u['member_name'] !== null): ?>
              <span style="color:var(--slate-soft);font-weight:400;">&mdash; <?= e($u['member_name']) ?> (<?= e($u['rank_name']) ?>)</span>
            <?php endif; ?>
          </span>
          <span class="rtag <?= $u['role'] ?>"><?= $u['role'] === 'admin' ? 'Admin' : 'User' ?></span>
          <?php if ((int) $u['id'] !== (int) $_SESSION['user_id']): ?>
            <form method="post" action="payment_ledger.php" onsubmit="return confirm('Delete user &quot;<?= e(addslashes($u['username'])) ?>&quot;?');" style="display:inline">
    ...
    <form method="post" action="payment_ledger.php">
      ...
      <div class="modal-actions">
        <a class="btn btn-secondary" href="payment_ledger.php?<?= buildQuery() ?>">Close</a>
